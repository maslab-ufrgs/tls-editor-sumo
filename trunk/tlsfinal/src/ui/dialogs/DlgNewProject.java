				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if (txtMapLocation.getText().trim().length() == 0) {
						...
						return;
                                      ...
                                      /* System.out.println("EDG:"+new File(txtMapLocation.getText().trim().replaceFirst(".net.", ".edg.")).exists()+ " NODE:"+ new File(txtMapLocation.getText().trim().replaceFirst(".net.", ".nod.")).exists()); 
